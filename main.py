...
class Ship(Game_Object):
    ...
    def __str__(self):
        ...
        _max_h_speed: %f
        _bullet_speed: %f
        _image: %s""" %(self._acceleration, self._max_v_speed, self._spin,
                       self._max_h_speed, self._bullet_speed, self._image_dir))
...
class UI:
    ...
    def __init__(self):
        ...
        # User
        self.user = Ship([100, 200], 'Images/ship.png', 0.7, 10, 10.0, 0.1, 10.0)
